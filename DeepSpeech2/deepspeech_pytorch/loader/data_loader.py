...
class SpectrogramDataset(Dataset, SpectrogramParser):
    def __init__(self, audio_conf, manifest_filepath, labels, normalize=False, speed_volume_perturb=False, spec_augment=False, debug=False):
        """
    ...
    def parse_transcript(self, transcript):
        ...
        transcript = list(filter(lambda x: x is not None, [self.labels_map.get(x) for x in list(transcript)]))
